...
export const getSpaceContent: (id: string) => Promise<AxiosResponse<Spaces>> = (id) => {
  console.log(`/v1/spaces/${id}/content`)
  return gitbookAPI.get(`/v1/spaces/${id}/content`)
}
export const getPageContent: (id: string, url: string) => Promise<AxiosResponse<any>> = (idSpace, url, debugMode = true) => {
