...
export const getSpaceContentTS: (id: string) => Promise<AxiosResponse<Spaces>> = (id) => {
  console.log(`/v1/spaces/${id}/content`)
  return gitbookAPITS.get(`/v1/spaces/${id}/content`)
}
export const getPageContentTS: (id: string, url: string) => Promise<AxiosResponse<any>> = (idSpace, url, debugMode = true) => {
